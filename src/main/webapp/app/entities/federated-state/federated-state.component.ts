...
@Component({
  selector: 'jhi-state',
  templateUrl: './federated-state.component.html'
})
export class FederatedStateComponent implements OnInit, OnDestroy {
  states?: IState[];
  ...
  constructor(
    protected stateService: FederatedStateService,
  ...
  delete(state: IState): void {
    const modalRef = this.modalService.open(FederatedStateDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
